...
class KeyStrokeLogger extends Component {
  ...
  constructor(props) {
    super(props);
    console.log(props)
    this.textAreaRef = props.textAreaRef;
    this.submitButtonRef = props.submitButtonRef;
  ...
  componentDidMount() {
    ...
    if (isInput) {
      ...
      this.textAreaRef.current.addEventListener("touchstart", this.handleTouch);
